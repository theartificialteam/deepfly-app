...
By downloading, installing, or using DeepFly ("the App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.

## 2. Description of Service

DeepFly is a mobile application that uses artificial intelligence to analyze photos and videos for potential deepfake manipulation. The App:

- Processes media files on your device
- Provides analysis results based on AI heuristics
- Stores results locally on your device

## 3. Important Disclaimer

**THE APP'S ANALYSIS RESULTS ARE FOR INFORMATIONAL PURPOSES ONLY.**

- Results are not 100% accurate
- The App may produce false positives or false negatives
- Results should NOT be used as legal evidence
- Results should NOT be used for professional verification
- You should seek expert opinion for important decisions
...
- Use analysis results to make false accusations
- Attempt to reverse engineer or hack the App
- Use the App in violation of any applicable laws
- Share analysis results as definitive proof of authenticity

## 5. User Accounts

### 5.1 Account Creation
- You may use the App as a guest or create an account
...
### 6.1 Free Tier
- Guest users: 5 analyses per day
- Free accounts: 20 analyses per day
...
- The App and its content are owned by DeepFly
...
- We are not liable for incorrect analysis results
- We are not liable for decisions made based on analysis results
- Our total liability shall not exceed the amount paid for the App

## 9. Indemnification

You agree to indemnify and hold harmless DeepFly from any claims arising from:
